...
export default async function Page({
  ...
  try {
    ...
    if (!response.reports || response.reports.length === 0) {
      ...
      return <GameWrapper game_id={null} scrambled_letters={null} duration={null} is_staked={null} />;
    }
    ...
    if (!parsedGameData.game_id || !parsedGameData.scrambled_letters || !parsedGameData.duration ) {
